          ...
          if (item.sender == me) {
            return (
              <div style={{ display: "flex", alignItems:"flex-end", justifyContent: "flex-end", marginTop:"10px"}}>
                  ...
                  <div style={{fontSize:"10px", marginRight: wWidth/100}}> 
                    {item.sentTime}
                  </div>
            ...
            return (
              <div>
                ...
                <div style={{fontSize:"12px", fontWeight:"bold", marginLeft: wWidth/100, marginTop:"10px", marginBottom:"5px"}}>
                  {item.sender}
                </div>
                ...
                <div style={{fontSize:"10px", marginLeft: wWidth/100}}> 
                  {item.sentTime}
                </div>
